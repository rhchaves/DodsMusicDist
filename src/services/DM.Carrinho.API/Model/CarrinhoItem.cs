...
namespace DM.Carrinho.API.Model;
...
public class CarrinhoItem
{
    ...
    {
        return new ItemCarrinhoValidacao().Validate(this).IsValid;
    }

    public class ItemCarrinhoValidacao : AbstractValidator<CarrinhoItem>
    {
        public ItemCarrinhoValidacao()
        {
