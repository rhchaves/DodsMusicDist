...
public class PagamentoCartaoCreditoFacade : IPagamentoFacade
{
    ...
    public static Transaction ParaTransaction(Transacao transacao, DodsPagService dodsPagService)
    {
        return new Transaction(dodsPagService)
        {
